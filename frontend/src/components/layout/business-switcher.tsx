...
export function BusinessSwitcher() {
  ...
  const menu = open && menuStyle && mounted ? (
    <>
      ...
      <div
        className="fixed z-[201] rounded-xl border border-border bg-card shadow-2xl overflow-hidden"
  ...
  const addModal = showAdd && mounted ? (
    <>
      ...
      <div className="fixed inset-0 z-[211] flex items-center justify-center p-4 pointer-events-none">
        <div className="w-full max-w-md rounded-xl border border-border bg-card p-6 shadow-2xl pointer-events-auto">
